...
const experienceAndEdu = {
    ...
    work: {
        hcl: {
            ...
            points: [
                "Spearheaded the frontend architecture for end-to-end sourcing workflows and resource lifecycle management using React and Next.js.",
                "Applied SOLID principles and a reusable component-based architecture, successfully reducing user onboarding time by 50%.",
                "Engineered seamless RESTful API integrations with Kronos for automated timesheet validation.",
                "Utilized Redux Toolkit for efficient state management across complex data grids, eliminating manual reconciliation for 100+ contractors while ensuring high UI performance.",
                "Designed and developed the user interface for an AI-enabled program reporting system.",
                "Built dynamic, interactive dashboards to handle Generative AI insights and automated distribution, which directly reduced manual reporting efforts by 60%.",
                "Authored and maintained comprehensive unit tests using Jest and React Testing Library to ensure component reliability and prevent regressions during continuous CI/CD deployments."
            ]
        },
        birbal: {
            logo: "Birbal.png",
            alt: "BirbalAI Logo",
            title: "Birbal AI Tech",
            client: "Reach Mobile",
            project: "Cube Mobile",
            role: "Software Developer (SDE2)",
            // duration: "...",
            location: "Hyderabad, Telangana.",
            points: [
                "Designed and engineered highly interactive, user-centric interfaces for personalized travel plans and digital wallet histories using React.js, directly boosting overall app engagement by 30%.",
                "Architected robust frontend data flows utilizing Redux Toolkit and React Router v6 to securely and efficiently manage complex state changes for real-time wallet transactions.",
                "Built reusable, scalable UI components utilizing styled-components and modern CSS, proactively incorporating WCAG accessibility best practices to ensure a seamless experience across diverse user demographics.",
                "Actively collaborated within an Agile Scrum framework, taking ownership of analyzing complex customer requirements and translating them into technical deliverables."
            ]
        },
        napier: {
            logo: "Napier.png",
    ...
    return (
        <div className='about-div'>
            ...
            <motion.p className='about-p mb-4' {...getTransitions(1.3)}>
                I am a driven Lead Engineer with a proven track record of designing and building dynamic, high-performance frontend applications. My expertise is deeply rooted in React.js and Next.js, where I pair modern state management through Redux Toolkit with a relentless focus on optimizing Core Web Vitals to maximize rendering speed and user interactivity. I am deeply passionate about writing clean, maintainable code and bringing a detail-oriented approach to robust testing architectures.
                <br />
                <br />
                ...
                <br />
                <br />
                I'm actively seeking collaborative opportunities where I can leverage my expertise to deliver intuitive, secure, and user-centric software solutions. Let's join forces to engineer highly engaging, accessible web experiences and elevate the digital landscape.
            </motion.p>
